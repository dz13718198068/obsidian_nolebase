...
![|381](assets/Pasted-image-20250518125220.png)
IP核的双击打开后的左上角有相关手册
![|425](assets/Pasted-image-20250518125401.png)
![|475](assets/Pasted-image-20250518130748.png)
为AXI接口提供了一个通用的输入输出接口
这是一个32bit的soft ip软核ip
用于与AXI4 lite接口进行连接

什么是软核IP?
![|350](assets/Pasted-image-20250518132037.png)
...
PS-PL接口分为功能性接口和配置接口
![|450](assets/Pasted-image-20250518132320.png)
功能接口AXI互联又分为ACP、HP和GP接口
![|425](assets/Pasted-image-20250518132458.png)
...
系统框图
![|475](assets/Pasted-image-20250518125130.png)
==AXI 互联 IP==（ AXI Interconnect）用于连接==AXI存储器映射==（ memory-mapped）的主器件和从器件。
通用中断控制器（ GIC） 用于管理来自 PS 或者 PL 的中断， 并把这些中断发送到 CPU。
![|500](assets/Pasted-image-20250518134003.png)
![|500](assets/Pasted-image-20250518134105.png)

---
硬件设计
添加ZYNQ_PS端IP。本次实验默认的这些接口都需要
![|400](assets/Pasted-image-20250518134616.png)
M_AXI_GP0：
...
进入配置：
配UART 0
![|500](assets/Pasted-image-20250518135021.png)
配DDR3
![|500](assets/Pasted-image-20250518135105.png)
配MIO（PS端的LED）（硬核）
![|500](assets/Pasted-image-20250518135419.png)
配置ZYNQ PS完成

添加AXI-GPIO IP核并配置
配置选项在pg114文档中有介绍
![|250](assets/Pasted-image-20250518140358.png)
...
![|475](assets/Pasted-image-20250518140640.png)

AXI-GPIO模块框图
IP端口介绍：
![|400](assets/Pasted-image-20250518141616.png)
![|500](assets/Pasted-image-20250518143642.png)
![|500](assets/Pasted-image-20250518143814.png)
![|500](assets/Pasted-image-20250518144757.png)
![|500](assets/Pasted-image-20250518145310.png)
IP寄存器空间介绍
![|500](assets/Pasted-image-20250518145715.png)
![|500](assets/Pasted-image-20250518145920.png)
![|500](assets/Pasted-image-20250518150114.png)
中断功能
![|500](assets/Pasted-image-20250518150228.png)
编程顺序：

使能中断
![|500](assets/Pasted-image-20250518150851.png)
不使用中断功能，配成输入
![|500](assets/Pasted-image-20250518151046.png)
配成输出
![|500](assets/Pasted-image-20250518151146.png)

---
IP核配置：
![|475](assets/Pasted-image-20250518151955.png)
模块自动连接+模块间自动连接
![|400](assets/Pasted-image-20250518152617.png)
![|400](assets/Pasted-image-20250518152658.png)
工具帮我们自动添加了两个IP核
![|675](assets/Pasted-image-20250518153108.png)
...
![|725](assets/Pasted-image-20250518153741.png)
...
时钟信号:
![](assets/Pasted-image-20250518153835.png)
![|500](assets/Pasted-image-20250518154146.png)
...
![|500](assets/Pasted-image-20250518154347.png)
ZYNQ7 PS 模块的中断接口 IRQ_F2P 没有自动连接， 需要手动连接
![|650](assets/Pasted-image-20250518154527.png)
将连接到PL端的端口改名，方便PL端使用
![|500](assets/Pasted-image-20250518154645.png)
封装之后看代码发现系统会自动帮我们创建三态缓冲器
![|325](assets/Pasted-image-20250518155249.png)
![|625](assets/Pasted-image-20250518155232.png)
分配引脚，PL按键
![|500](assets/Pasted-image-20250518155516.png)
生成bit流
导出到SDK
...
![|575](assets/Pasted-image-20250518160121.png)
导入中断模式示例
![|550](assets/Pasted-image-20250518163756.png)
按照示例编写代码
...
一共16个中断ID
只使用了1个，中断号就是61
![|425](assets/Pasted-image-20250518180048.png)
ZYNQ_PS配置也能看到中断号
![|450](assets/Pasted-image-20250518180220.png)
中断类型：高有效
![|475](assets/Pasted-image-20250518195555.png)
![|475](assets/Pasted-image-20250518195714.png)
按下亮，释放灭
按一次按键中断两次（按下+释放）：是因为电平变化检测到中断
现象与预期不符
看编程顺序，还需要读一下状态
![|500](assets/Pasted-image-20250518202526.png)
