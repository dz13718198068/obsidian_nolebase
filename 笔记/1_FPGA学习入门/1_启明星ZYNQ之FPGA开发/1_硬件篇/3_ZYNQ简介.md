- [一、ZYNQ PL 简介](3_ZYNQ简介.md#一、ZYNQ%20PL%20简介)
		- [1. 可编程输入/输出单元](3_ZYNQ简介.md#1.%20可编程输入/输出单元)
		- [2. 基本可编程逻辑单元](3_ZYNQ简介.md#2.%20基本可编程逻辑单元)
		- [5. 嵌入式块 RAM](3_ZYNQ简介.md#5.%20嵌入式块%20RAM)
		- [4. 丰富的布线资源](3_ZYNQ简介.md#4.%20丰富的布线资源)
		- [5. 底层内嵌功能单元](3_ZYNQ简介.md#5.%20底层内嵌功能单元)
		- [6. 内嵌专用硬核](3_ZYNQ简介.md#6.%20内嵌专用硬核)
		- [7. ZYNQ PL 架构](3_ZYNQ简介.md#7.%20ZYNQ%20PL%20架构)
- [二、ZYNQ PS 简介](3_ZYNQ简介.md#二、ZYNQ%20PS%20简介)
	- [PS部分](3_ZYNQ简介.md#二、ZYNQ%20PS%20简介#PS部分)
			- [1. APU](3_ZYNQ简介.md#7.%20ZYNQ%20PL%20架构#1.%20APU)
			- [2. APU之外](3_ZYNQ简介.md#7.%20ZYNQ%20PL%20架构#2.%20APU之外)
			- [3. PS与PL之间的接口](3_ZYNQ简介.md#7.%20ZYNQ%20PL%20架构#3.%20PS与PL之间的接口)
			- [4. PS外部接口](3_ZYNQ简介.md#7.%20ZYNQ%20PL%20架构#4.%20PS外部接口)
- [三、ZYNQ 的优势](3_ZYNQ简介.md#三、ZYNQ%20的优势)
	- [1. ZYNQ 应用的领域](3_ZYNQ简介.md#三、ZYNQ%20的优势#1.%20ZYNQ%20应用的领域)
...
- 嵌入式块 RAM 
- 内嵌专用硬核
![|580](assets/Pasted-image-20250604213959.png)
##### 1. 可编程输入/输出单元
...
![|620](assets/Pasted-image-20250604214142.png)
##### 2. 基本可编程逻辑单元
...
![|580](assets/Pasted-image-20250604214637.png)
CLB 是逻辑单元的最小组成部分，在 PL 中排列为一个二维阵列，通过可编程互联连接到其他类似的资源。每个 CLB 里包含两个逻辑片，并且紧邻一个开关矩阵， 如下图所示
![|620](assets/Pasted-image-20250604214659.png)
##### 5. 嵌入式块 RAM
...
![|580](assets/Pasted-image-20250604214810.png)
...
##### 7. ZYNQ PL 架构
![](assets/Pasted-image-20250604215310.png)
...
PS：SoC
PL：可编程逻辑器件
![](assets/Pasted-image-20250604112035.png)
#### PS部分
###### 1. APU
...
![|420](assets/Pasted-image-20250604112059.png)
###### 2. APU之外
...
![](assets/Pasted-image-20250526075553.png)
###### 4. PS外部接口
![|500](assets/Pasted-image-20250604220203.png)
