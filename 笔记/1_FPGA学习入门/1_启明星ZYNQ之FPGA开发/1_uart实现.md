...
串行数据的方向：单工、半双工、全双工
![](assets/Pasted-image-20250526081814.png)
...
I2C：
![](assets/Pasted-image-20250526081824.png)
...
①协议层
协议层：数据格式
![](assets/Pasted-image-20250526081830.png)
...
②物理层
物理层：接口标准
![](assets/Pasted-image-20250526081843.png)

**3、RS232接口**

DB9接口
![](assets/Pasted-image-20250526081848.png)
RXD、TXD、GND三个接口组成了串口通信

**4、USB接口**
Date+-：一对差分线组成信号线，用于传输数据
ID：用于识别Type型号
![](assets/Pasted-image-20250526081853.png)
...
接收端模块
![](assets/Pasted-image-20250526081904.png)

接收端代码：见文末
接收端仿真代码：见文末
接收端仿真结果
![](assets/Pasted-image-20250526081913.png)

发送端模块
![](assets/Pasted-image-20250526081917.png)

发送端代码：见文末
发送端仿真代码：见文末
发送端仿真结果
![](assets/Pasted-image-20250526081935.png)

top顶层设计
![](assets/Pasted-image-20250526081931.png)

top顶层代码：见文末
top顶层仿真代码：见文末
top仿真结果
![](assets/Pasted-image-20250526081943.png)
**三、上板验证流程**
...
![](assets/Pasted-image-20250526081947.png)

连接线路，将CH340C的发送端连接fpga接收端，CH340C接收端连接fpga发送端
![](assets/Pasted-image-20250526081950.png)

分配fpga的引脚
![](assets/Pasted-image-20250526081955.png)

通过查询硬件原理图，将引脚分配给M19和U14
![](assets/Pasted-image-20250526081958.png)

上板测试发现发送55后未收到数据
![](assets/Pasted-image-20250526082001.png)
...
![](assets/Pasted-image-20250526082226.png)

**定位原因：杜邦线插错位置导致。”※“标注位置应为硬件原理图接口“1”的位置。**
![](assets/Pasted-image-20250526082228.png)

再测试完整的Uart程序后，发现运行无误
![](assets/Pasted-image-20250526082232.png)
