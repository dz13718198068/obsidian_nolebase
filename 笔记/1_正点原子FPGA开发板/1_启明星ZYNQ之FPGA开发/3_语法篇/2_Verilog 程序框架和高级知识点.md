- [一、Verilog 程序框架](#一、Verilog%20程序框架)
	- [3.1 注释](#一、Verilog%20程序框架#3.1%20注释)
	- [3,2 关键字](#一、Verilog%20程序框架#3,2%20关键字)
	- [3.3 程序框架](#一、Verilog%20程序框架#3.3%20程序框架)
- [二、Verilog 高级知识点](#二、Verilog%20高级知识点)
	- [2.1 阻塞赋值（ Blocking）](#二、Verilog%20高级知识点#2.1%20阻塞赋值（%20Blocking）)
	- [2.2 非阻塞赋值（ Non-Blocking）](#二、Verilog%20高级知识点#2.2%20非阻塞赋值（%20Non-Blocking）)
	- [2.3 assign 和 always 区别](#二、Verilog%20高级知识点#2.3%20assign%20和%20always%20区别)
	- [2.4 带时钟和不带时钟的 always](#二、Verilog%20高级知识点#2.4%20带时钟和不带时钟的%20always)
	- [2.5 什么是 latch](#二、Verilog%20高级知识点#2.5%20什么是%20latch)
	- [2.6 状态机](#二、Verilog%20高级知识点#2.6%20状态机)
	- [2.7 模块化设计](#二、Verilog%20高级知识点#2.7%20模块化设计)
...
## 3,2 关键字
**所有关键字**
![|620](assets/Pasted%20image%2020250605191429.png)
**常用关键字**
![|580](assets/Pasted%20image%2020250605191443.png)
==关键字需小写==
...
![|620](assets/Pasted%20image%2020250605194948.png)
阻塞赋值语句
...
1. 赋值开始的时候，计算 RHS；
2. 赋值结束的时候，更新 LHS。
![|500](assets/Pasted%20image%2020250605195159.png)
...
![|700](assets/Pasted%20image%2020250605195355.png)
==在描述时序逻辑的时候，使用非阻塞赋值==
综合成时序逻辑的电路结构，比如带时钟的 always 语句；
这种电路结构往往与触发沿有关系，只有在触发沿时才可能发生赋值的变化，
![](assets/Pasted%20image%2020250605195440.png)
...
![|700](assets/Pasted%20image%2020250605200751.png)
![](assets/Pasted%20image%2020250605200810.png)
## 2.6 状态机
...
1. Mealy 状态机
![](assets/Pasted%20image%2020250605201000.png)
2. Moore 状态机
![](assets/Pasted%20image%2020250605201007.png)
3. 三段式状态机
三段式状态机的基本格式是：
- 第一个 always 语句实现同步状态跳转；
- 第二个 always 语句采用组合逻辑判断状态转移条件；
- 第三个 always 语句描述状态输出(可以用组合电路输出，也可以时序电路输出)。
![](assets/Pasted%20image%2020250605201154.png)
## 2.7 模块化设计
![](assets/Pasted%20image%2020250605201249.png)
**模块的例化**
![](assets/Pasted%20image%2020250605201317.png)
**模块参数的例化**
![](assets/Pasted%20image%2020250605201331.png)
