...
# 一、FPGA 开发流程
![|540](assets/Pasted-image-20250605091013.png)
# 二、FPGA 工程管理
主要分为以下四类：
...
![|420](assets/Pasted-image-20250605092730.png)
# 三、点亮 LED 灯
## 3.1 功能分析
PL_KEY0 按键来控制底板上的 PL_LED0 灯亮灭。
按下点亮、松开熄灭。
## 3.2 硬件介绍
![|500](assets/Pasted-image-20250605095231.png)
![|420](assets/Pasted-image-20250605095243.png)
## 3.3 系统设计
进行模块划分和梳理模块间交互信号
## 3.4 硬件介绍
使用Viso绘制，绘制文件放在doc文件下
![|460](assets/Pasted-image-20250605095524.png)
![|460](assets/Pasted-image-20250605095624.png)
![|380](assets/Pasted-image-20250605095635.png)
![|460](assets/Pasted-image-20250605095644.png)
正点原子提供了Viso模具
![|500](assets/Pasted-image-20250605095733.png)
复制到我的形状里
![|500](assets/Pasted-image-20250605095804.png)
![|540](assets/Pasted-image-20250605095826.png)
## 3.5 绘制波形图
实际效果图
![|460](assets/Pasted-image-20250605100101.png)
根据效果图绘制真值表
![|500](assets/Pasted-image-20250605100145.png)
波形图绘制技巧：
- 输入信号的颜色定义为绿色，
- 输出的信号定义为红色，
- 中间变量信号定义为蓝色。
![|500](assets/Pasted-image-20250605100323.png)
绘制波形完成后按照波形编写RTL代码。
## 3.6 编写RTL代码
采用Notepad++工具来编写代码
好用
...
![|500](assets/Pasted-image-20250605100927.png)
在 tb 文件夹下面新建一个“tb_led.v”
![|500](assets/Pasted-image-20250605100951.png)
...
**在 modelsim中仿真**
**建立project**
![|460](assets/Pasted-image-20250605103114.png)
![|460](assets/Pasted-image-20250605103131.png)
![|460](assets/Pasted-image-20250605103233.png)
...
![|500](assets/Pasted-image-20250605103320.png)
**添加仿真文件**
![|500](assets/Pasted-image-20250605103459.png)
**文件添加完成**
![|500](assets/Pasted-image-20250605103537.png)
**编译：**
- Compile Selected（编译所选）
- Compile All（编译全部）
![|500](assets/Pasted-image-20250605103633.png)
- Compile Order：文件编译顺序，可以调整编译的.v 文件的编译顺序。
- Compile Report：编译报告，内容为当次编译的详细报告。
- Compile Summary：编译摘要，执行过的编译操作都在编译摘要有记录。

**编译完成：**
![|500](assets/Pasted-image-20250605103715.png)
- “√”表示编译通过状态
- “×”表示编译错误
- 黄色的三角符表示包含警告的编译通过

**开始配置仿真环境：【Simulate】→【Start Simulation...】**
![|500](assets/Pasted-image-20250605103931.png)
...
- SDF：Standard Delay Format（标准延迟格式）的缩写，内部包含了各种延迟信息，也是用于时序仿真的重要文件。 
  ...
  ![|460](assets/Pasted-image-20250605112724.png)
- Others

**勾选“Enable optimization”**
![|420](assets/Pasted-image-20250605114209.png)
**优化选项进行如下图设置**
![|460](assets/Pasted-image-20250605114246.png)
如果不进行上面的优化选项配置， Modelsim SE-64 2020.4 仿真会报如下截图所示错误
![|340](assets/Pasted-image-20250605114353.png)
**点击“OK” 就可以开始进行功能仿真**
![|460](assets/Pasted-image-20250605114420.png)
![|460](assets/Pasted-image-20250605114437.png)
**添加查看的信号**
![|420](assets/Pasted-image-20250605114509.png)
![|500](assets/Pasted-image-20250605114524.png)
**仿真按钮，如下图**
![|380](assets/Pasted-image-20250605114553.png)
Restart：复位仿真，点击该按钮会有一个弹框如下图所示
![|420](assets/Pasted-image-20250605114616.png)
...
**选择仿真时间为 10us**
![|500](assets/Pasted-image-20250605114749.png)
**仿真结果**
![|540](assets/Pasted-image-20250605114805.png)
**ModelSim 软件中几个常用小工具**
放大、缩小和全局显示功能，有快捷键
![|540](assets/Pasted-image-20250605114828.png)
黄色图标是用来在波形图上添加用来标志的黄色竖线，紧跟着的是将添加的黄色竖线对齐到信号的下降沿和上升沿
![|580](assets/Pasted-image-20250605114906.png)
**当我们需要对 IP 核进行仿真时一定要事先将 IP 核的库文件加载到Modelsim 库中去。**
RTL 代码仿真验证完成

## 3.8 新建工程
![|460](assets/Pasted-image-20250605121333.png)
![|460](assets/Pasted-image-20250605121339.png)
![|460](assets/Pasted-image-20250605121411.png)
![|500](assets/Pasted-image-20250605121438.png)
工程类型选择：
...
**选择开发板的芯片型号**
![|500](assets/Pasted-image-20250605121626.png)
![|580](assets/Pasted-image-20250605121712.png)
Category:种类，如下图所示按照芯片用途有四个类别
- Automotive ：车用芯片；
- General Purpose：一般用途的芯片； 
- Military/Hi-Reliability：军用/高可靠性的芯片； 
- Radition Tolerant：辐射耐受性的芯片；
![|500](assets/Pasted-image-20250605121746.png)
![|500](assets/Pasted-image-20250605121903.png)
**工程界面：**
![](assets/Pasted-image-20250605121928.png)
...
![|620](assets/Pasted-image-20250605122351.png)
### 3.9.2 手动设置顶层
...
![|500](assets/Pasted-image-20250605122552.png)
Vivado 会生成顶层原理图视图，并在默认 view layout 中显示设计。此页面可分配I/O
![|540](assets/Pasted-image-20250605122659.png)
- Name：工程中顶层端口的名称。
...
![|620](assets/Pasted-image-20250605122804.png)
引脚配置在硬件原理图
==供电电压在原理图的bank供电电压==
![|500](assets/Pasted-image-20250605123056.png)
管脚约束
![|500](assets/Pasted-image-20250605123143.png)
![|620](assets/Pasted-image-20250605123132.png)
“Ctrl+S”保存
管脚约束也可以手敲
...
```
### 3.10.2 对代码进行综合
![|460](assets/Pasted-image-20250605123852.png)
**“Open Synthesized Design”选项打开综合设计。**
![|460](assets/Pasted-image-20250605123925.png)
**综合后原理图**
![|540](assets/Pasted-image-20250605123948.png)
- IBUF 是输入缓存
- OBUF 是输出缓存
- 取反通过一个 LUT1实现
...
![|460](assets/Pasted-image-20250605124058.png)
## 3.11 设计实现
**“Run Implementation”**
![|460](assets/Pasted-image-20250605124216.png)
**打开实现设计**
![](assets/Pasted-image-20250605124245.png)
Netlist”窗口中有“Nets”与“Leaf Cells”，点击“Nets”与“Leaf Cells”下面的选项，右边的器件图会高亮对应模块，所以实现设计将代码映射到了 FPGA 底层资源上。
**查看“ Design Runs”窗口中的实现结果**
![](assets/Pasted-image-20250605124341.png)
与综合的选项类似
![|460](assets/Pasted-image-20250605125003.png)
### 3.12 下载验证
![|420](assets/Pasted-image-20250605133524.png)
**生成bit流**
![|540](assets/Pasted-image-20250605133539.png)
**打开硬件管理**
![|460](assets/Pasted-image-20250605133631.png)
**连接硬件**
![|420](assets/Pasted-image-20250605133650.png)
**“Auto Connect”**
![|500](assets/Pasted-image-20250605133706.png)
**“ Program Device”**
![|500](assets/Pasted-image-20250605133820.png)
**下载程序**
![|460](assets/Pasted-image-20250605134046.png)
