...
![](assets/Pasted-image-20250526083901.png)
![](assets/Pasted-image-20250526083904.png)
![](assets/Pasted-image-20250526083906.png)
![](assets/Pasted-image-20250526083909.png)


信号的描述
信号在全局时钟上升沿采样，复位信号低电平有效
![|500](assets/Pasted-image-20250517150356.png)
写地址通道信号： 
AWID
==AWADDR==：写地址，起始地址
==AWLEN==：突发长度。有个+1
...
![|525](assets/Pasted-image-20250517150413.png)
写数据通道信号：
WID：
==WDATA==：写入数据
...
![|475](assets/Pasted-image-20250517150425.png)
写响应通道信号：
BID：
==BRESP==：写传输状态，从机发给主机
...
==BVALID==：slave发出。
==BREADY==：master发出。
![|500](assets/Pasted-image-20250517152602.png)
读地址通道信号：
ARID：
==ARADDR==：读地址
==ARLEN==：突发长度
...
==ARVALID==：握手机制。
==ARREADY==：握手机制。
![](assets/Pasted-image-20250517152740.png)
读操作通道：
RID：
==RDATA==：读数据
RRESP：读响应
...
时钟：使用全局时钟ACLK，上升沿采样
复位：
![](assets/Pasted-image-20250517153632.png)


![|425](assets/Pasted-image-20250517154737.png)
握手处理：
...
![|500](assets/Pasted-image-20250517154508.png)
![|500](assets/Pasted-image-20250517154630.png)
![|500](assets/Pasted-image-20250517155311.png)
写地址通道：
当地址和控制信息有效时，主机才能拉高AWVALID信号
当AWVALID信号拉高之后，要保持不变直到下一个时钟上升沿
![](assets/Pasted-image-20250517155340.png)
...
五缓存
不支持独占式访问
![|425](assets/Pasted-image-20250517162231.png)
接口较少
![|475](assets/Pasted-image-20250517162301.png)


时序图：
![|525](assets/Pasted-image-20250517162458.png)
![|525](assets/Pasted-image-20250517162649.png)
