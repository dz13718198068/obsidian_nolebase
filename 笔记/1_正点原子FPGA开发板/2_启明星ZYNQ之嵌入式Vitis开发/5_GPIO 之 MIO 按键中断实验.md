...
![](photo/Pasted%20image%2020250526074001.png)
![](photo/Pasted%20image%2020250526074015.png)
...
![](photo/Pasted%20image%2020250526074023.png)

MIO的分配可任意分配，但对外设的引脚又有所约束，下图为MIO一览表
![](photo/Pasted%20image%2020250526074029.png)

**点灯**

系统框图

![](photo/Pasted%20image%2020250526074034.png)
该程序需要用到MIO接口，所以需要把PS IP核的GPIO MIO接口打开
![](photo/Pasted%20image%2020250526074346.png)
在vitis里需要打开板级支持包，启用GIPO的驱动程序
![](photo/Pasted%20image%2020250526074038.png)


xgpiops_intr_example 是关于中断方式的示例

xgpiops_polled_example是关于轮询的示列，此处未用到中断，选该选项即可
![](photo/Pasted%20image%2020250526074044.png)


新增文件即为刚添加的例程，该程序里有对MIO的调用，可利用该程序修改接口位置实现连接LED
![](photo/Pasted%20image%2020250526074049.png)


修改.c文件中的引脚号，与板子LED引脚对应
![](photo/Pasted%20image%2020250526074052.png)
...
**头文件**
![](photo/Pasted%20image%2020250526074056.png)
...
 sleep.h：提供延时函数sleep()。
![](photo/Pasted%20image%2020250526074101.png)


GPIO的设备ID，从xparameters.h中获取
![](photo/Pasted%20image%2020250526074105.png)


XGpioPs是Xilinx提供的GPIO驱动结构体，用于管理GPIO状态和配置
![](photo/Pasted%20image%2020250526074111.png)
...
![](photo/Pasted%20image%2020250526074116.png)

XGpioPs_SetDirectionPin：设置引脚方向，1为输出，0为输入。

XGpioPs_SetOutputEnablePin：使能引脚输出，1为使能。
![](photo/Pasted%20image%2020250526074119.png)
![]() 
...
MIO的引脚配置见电路原理图
![](photo/Pasted%20image%2020250526074122.png)
![]() 
![](photo/Pasted%20image%2020250526074129.png)
![]() 
![](photo/Pasted%20image%2020250526074132.png)
 
