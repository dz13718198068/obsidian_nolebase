...
![|600](assets/Pasted-image-20250519110011.png)
创建新IP核
![|250](assets/Pasted-image-20250519110119.png)
开发板型号在使用ip时会重新指定，所以此处Part默认即可
![|575](assets/Pasted-image-20250519110518.png)
创建封装
选择封装 IP 或者创建一个带 AXI4 接口的 IP 核
我们这里选择创建一个带 AXI 接口的 IP核
选中“Creat a new AXI4 peripheral”
![|600](assets/Pasted-image-20250519111854.png)
![|600](assets/Pasted-image-20250519111939.png)
对 AXI 接口进行设置
- Name（名称）：S0_AXI。
...
![|550](assets/Pasted-image-20250519113246.png)
保持默认，即将 IP 添加至 IP 库中
![|575](assets/Pasted-image-20250519113330.png)
在IP catalog中成功添加了AXI IP
![|525](assets/Pasted-image-20250519113531.png)
右键编辑IP核，即打开IP的工程
![|600](assets/Pasted-image-20250519113621.png)
添加所需代码，IP核里都标注好了user应该在哪里写代码
![|375](assets/Pasted-image-20250519114400.png)
![|475](assets/Pasted-image-20250519114616.png)
增加IP核例化端口
![|500](assets/Pasted-image-20250519113951.png)
breath_led_ip_v1_0_S0_AXI 模块实现了 AXI4 协议下的读写寄存器的功能，
我们只需要对该模块稍作修改，
即可实现控制 PL LED 呼吸灯的功能。
向寄存器中写入数据和读出数据的部分代码如下
![|425](assets/Pasted-image-20250519114420.png)
![|525](assets/Pasted-image-20250519114148.png)
![|500](assets/Pasted-image-20250519114200.png)
在创建和封装 IP 核向导中，我们总共定义了 4 个寄存器，
代码中的 slv_reg0 至 slv_reg3 是寄存器地址0 至寄存器地址 3 对应的数据，
通过例化呼吸灯模块，将寄存器地址对应的数据和呼吸灯模块的控制端口相连接，
即可实现对呼吸灯的控制
再次添加代码：
![|575](assets/Pasted-image-20250519114547.png)
例化 breath_led.v文件
![|600](assets/Pasted-image-20250519114834.png)
...
![|375](assets/Pasted-image-20250519115206.png)
添加创建源文件
![|350](assets/Pasted-image-20250519115353.png)
写个呼吸灯的代码接口对好了就ok了
![|375](assets/Pasted-image-20250519120143.png)
代码无误后综合编译
![|375](assets/Pasted-image-20250519120340.png)
设置 IP 封装，将界面切换至 Package IP，
如果不小心关闭的话，可以通过 IP-XACT界面下的 component.xml 重新打开，
![|700](assets/Pasted-image-20250519120451.png)
Categories 选项下的“ +”按钮可用来修改 IP 的分类（此处不改）
![|400](assets/Pasted-image-20250519120559.png)
Compatibility，修改该 IP 核支持的器件
![|575](assets/Pasted-image-20250519120645.png)
Life-cycle 表明该 IP 核当前的产品生命周期，选择“ Pre-Production”
![|300](assets/Pasted-image-20250519120732.png)


Merge Changes三板斧，点就行
![|625](assets/Pasted-image-20250519120906.png)
![|650](assets/Pasted-image-20250519120946.png)
![|650](assets/Pasted-image-20250519121119.png)
![|650](assets/Pasted-image-20250519121148.png)

这是对代码中parameter参数的设定
![|550](assets/Pasted-image-20250519121253.png)
![|375](assets/Pasted-image-20250519121410.png)
参数拖动到page0里
![|450](assets/Pasted-image-20250519121541.png)
更新总结界面
![|625](assets/Pasted-image-20250519121615.png)
封装完成


Vivado软件会自动生成.c 和.h 文件，方便在 SDK 软件中对 IP 核进行操作
![|700](assets/Pasted-image-20250519121754.png)

创建工程，把自定义ip核添加到此工程ip库中
![|575](assets/Pasted-image-20250519122216.png)
![|600](assets/Pasted-image-20250519122255.png)
![|450](assets/Pasted-image-20250519122338.png)
![|525](assets/Pasted-image-20250519122433.png)
...
修改 DDR3 的存储器类型型号，
![|425](assets/Pasted-image-20250519122759.png)
添加Breath LED IP核
![|400](assets/Pasted-image-20250519122845.png)
查看可配置参数，与设定一致
![|575](assets/Pasted-image-20250519122913.png)
“Run Connection Automation”来自动连线
![|675](assets/Pasted-image-20250519123009.png)
增加LED引脚并改名
![|525](assets/Pasted-image-20250519123040.png)
最终原理图
![|675](assets/Pasted-image-20250519123124.png)
生成顶层 HDL 模块
添加xdc
![|650](assets/Pasted-image-20250519145522.png)
