...
udp协议报文结构
![](photo/Pasted%20image%2020250526084048.png)

UDP的首部有共8字节(而TCP\IP的首部有20字节)
![](photo/Pasted%20image%2020250526084050.png)
...
![](photo/Pasted%20image%2020250526084053.png)

代码中结构体定义
![](photo/Pasted%20image%2020250526084057.png)

**二、UDP数据递交流程**

首先申请一个pbuf，其中有个54字节空间。用于保存各层的首部
![](photo/Pasted%20image%2020250526084101.png)
![](photo/Pasted%20image%2020250526084103.png)
![](photo/Pasted%20image%2020250526084106.png)
...
**三、UDP控制块结构**
![](photo/Pasted%20image%2020250526084109.png)
...
**四、UDP控制块原理**
![](photo/Pasted%20image%2020250526084112.png)
![](photo/Pasted%20image%2020250526084115.png)