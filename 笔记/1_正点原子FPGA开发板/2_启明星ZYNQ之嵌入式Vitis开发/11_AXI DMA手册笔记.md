...
- 目的地址 — 数据被写入的地址
- 传输长度 — 应被传输的字节数
![|700](photo/Pasted%20image%2020250519090540.png)
DMA 存储传输的过程如下：
...
单一模式 or s/g模式
![|350](photo/Pasted%20image%2020250521165841.png)
![](photo/Pasted%20image%2020250521170725.png)
接口
![](photo/Pasted%20image%2020250522121118.png)
![](photo/Pasted%20image%2020250522103810.png)
...
最大时钟频率
![](photo/Pasted%20image%2020250522121248.png)

框图
![](photo/Pasted%20image%2020250522123118.png)

接口时钟
![](photo/Pasted%20image%2020250522123141.png)
两种时钟模式：异步、同步
![](photo/Pasted%20image%2020250522123527.png)
复位
![](photo/Pasted%20image%2020250522123638.png)
编程顺序
...
![](photo/Pasted%20image%2020250522124017.png)
![](photo/Pasted%20image%2020250522143159.png)
...
![](photo/Pasted%20image%2020250522145557.png)
![](photo/Pasted%20image%2020250522145929.png)
...
循环DMA模式：
    在s/g模式基础上做了个循环
![|450](photo/Pasted%20image%2020250522150636.png)

AXI DMA IP核介绍
![](photo/Pasted%20image%2020250522163739.png)
使能异步时钟（自动的，连线后会自适配）
