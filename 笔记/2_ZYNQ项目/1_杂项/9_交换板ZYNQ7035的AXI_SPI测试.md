...
![|220](assets/Pasted-image-20260107085550.png)
<font color="#ff0000">环路测试的系统框图：</font>
![|300](assets/Pasted-image-20260107085655.png)

## 2、SPI总线协议介绍

##### 2.1 技术性能
SPI，全双工三线同步串行外围解耦，主从模式，支持单主多从。Master控制时钟，高位在前，低位在后。两根单向数据线，全双工，实际应用速率可达机Mbps。
![|300](assets/Pasted-image-20260107090021.png)
##### 2.2 接口定义：
...
![|340](assets/Pasted-image-20260107094510.png)
![|340](assets/Pasted-image-20260107094426.png)
![|700](assets/Pasted-image-20260107100747.png)

##### 2.4 数据传输
一个 SPI 时钟周期内：
1. 主机通过 MOSI 线发送 1 位数据，从机通过该线读取这 1 位数据 
2. 从机通过 MISO 线发送 1 位数据，主机通过该线读取这 1 位数据
![|260](assets/Pasted-image-20260107094725.png)
![|700](assets/Pasted-image-20260107100242.png)
主机内的时钟发生器，同时影响主机和从机。
...
![|380](assets/Pasted-image-20260107224016.png)
sdk里debug as，run
```c
...
搭建soc
中断设置
![|420](assets/Pasted-image-20260107225514.png)
设置 GP Master 接口
![|420](assets/Pasted-image-20260107225550.png)
设置复位输出
![|460](assets/Pasted-image-20260107225619.png)
设置 PL 时钟
![|460](assets/Pasted-image-20260107225806.png)
AXI-SPI IP
![|460](assets/Pasted-image-20260107225827.png)
最终形态
![](assets/Pasted-image-20260109225213.png)
为了满足三态，顶层应该这样修改
![|207](assets/Pasted-image-20260109225313.png)
![|234](assets/Pasted-image-20260109225334.png)
![|380](assets/Pasted-image-20260109225345.png)
引脚分配对应关系
![](assets/Pasted-image-20260109230512.png)
### 3.2 PS部分
下面代码为不断往SPI里写入0x55的程序
运行时遇到问题，打断点定位到这个地方
![|460](assets/Pasted-image-20260109230228.png)
