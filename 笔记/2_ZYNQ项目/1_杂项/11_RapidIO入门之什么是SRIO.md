...
![](photo/Pasted%20image%2020260115165926.png)
...
![|660](photo/Pasted%20image%2020260115170027.png)
...
![|620](photo/Pasted%20image%2020260115170119.png)
...
##### I/O 端口类型
![](photo/Pasted%20image%2020260115170303.png)
**顶层信号映射**
![|380](photo/Pasted%20image%2020260115170323.png)
...
#### 寄存器空间
![](photo/Pasted%20image%2020260115170418.png)

### HELLO 包格式
标准化包头域，包头与数据分离传输：
- **Size 域**：值 = 传输字节总数 - 1（有效范围 0~255 → 实际传输 1~256 字节）
- **限制**：必须与 RapidIO 包中的 size/address/wdptr 域匹配，IP 核不会修正非法值。
![](photo/Pasted%20image%2020260115170457.png)

### SRIO 事务类型及关系

#### 1. 直接 I/O（DMA）事务
![](photo/Pasted%20image%2020260115170523.png)

#### 2. 消息传递事务
![](photo/Pasted%20image%2020260115170534.png)

#### 3. 维护事务
![](photo/Pasted%20image%2020260115170545.png)

#### 事务对比
![](photo/Pasted%20image%2020260115170555.png)
