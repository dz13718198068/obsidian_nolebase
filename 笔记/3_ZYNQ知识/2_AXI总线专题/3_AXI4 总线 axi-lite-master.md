...
![|500](assets/Pasted-image-20260202151257.png)
...
![|500](assets/Pasted-image-20260202152306.png)
...
![](assets/Pasted-image-20260202153916.png)
...
![](assets/Pasted-image-20260202154644.png)
...
![](assets/Pasted-image-20260202155122.png)
...
![](assets/Pasted-image-20260202155841.png)
...
![](assets/Pasted-image-20260202160606.png)
...
![](assets/Pasted-image-20260202161114.png)
...
![](assets/Pasted-image-20260202161827.png)
...
![](assets/Pasted-image-20260202163311.png)
...
![](assets/Pasted-image-20260202164857.png)
...
![](assets/Pasted-image-20260202165101.png)
...
![](assets/Pasted-image-20260202230342.png)
...
![](assets/Pasted-image-20260202230611.png)
...
模块 3：状态机跳转逻辑（核心闭环）
![](assets/Pasted-image-20260202230519.png)

###### 15:最后一个写数据
`last_write` 和 `writes_done` 逻辑是 AXI 主机**写事务完成的精准判定逻辑**，核心解决了 “如何确认批量写事务的最后一次传输完成” 的问题
![](assets/Pasted-image-20260202231312.png)
![](assets/Pasted-image-20260202231336.png)
![](assets/Pasted-image-20260202231348.png)

###### 16:最后一个读数据

![](assets/Pasted-image-20260202231544.png)
![](assets/Pasted-image-20260202231556.png)
...
###### 3.1 写数据过程
![](assets/Pasted-image-20260203095701.png)

###### 3.2 读数据过程
![](assets/Pasted-image-20260203101237.png)
